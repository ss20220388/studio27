                ...
                .oauth2Login(oauth -> oauth
                        .successHandler((request, response, authentication) -> {
                            try {
                                ...
                                System.out.println("Device ID from cookie: " + deviceId);

                                // Ako nema deviceId - odbij
                                if (deviceId == null || deviceId.isEmpty()) {
                                    ResponseCookie errorCookie = ResponseCookie
                                            .from("losGmail", "missing_device_id")
                                            .httpOnly(false)
                                            .secure(cookieSecure)
                                            .path("/")
                                            .maxAge(10)
                                ...
                                if (count == null || count == 0) {
                                    ...
                                    jdbcTemplate.update(
                                            ...
                                            "");
                                    System.out.println("New user created with deviceId: " + deviceId);
                                } else {
