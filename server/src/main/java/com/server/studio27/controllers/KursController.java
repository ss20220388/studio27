...
public class KursController {
 ...
 public ResponseEntity<List<Kurs>> getAllKurseviSaLekcijama() {
    ...
    String SQL = """
        SELECT kursId,
               k.naziv as "Naziv kursa",
               k.opis as "Opis kursa",
               cena,
               trajanje as "Trajanje u danima",
               slikaUrl as "Slika kursa",
               lekcijaId,
               l.naziv as "Naziv lekcije",
               l.opis as "Opis lekcije",
               url as "Video url"
        FROM Kurs k
        LEFT JOIN Lekcija l USING(kursId)
