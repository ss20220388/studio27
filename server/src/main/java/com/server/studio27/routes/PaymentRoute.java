...
public class PaymentRoute {
        ...
        public record PaymentCreateRequest(String orderId, Long studentId, List<Long> courseIds,
        ...
        @CrossOrigin(origins = { "https://27archviz.com", "https://www.27archviz.com",
                        "http://localhost:4321" }, allowCredentials = "true")
        ...
        @GetMapping("/payment/canary")
        public ResponseEntity<String> canary() {
                return ResponseEntity.ok("NOVI KOD RADI - v2");
        }

        @RequestMapping(value = "/payment/notify", method = { RequestMethod.GET,
        ...
        public ResponseEntity<String> paymentNotify(@RequestParam Map<String, String> params) {
                ...
                if (signatureValid) {
                        try {
                                ...
                                System.err.println("[PaymentRoute] Upis u uplatnica/pohadja nije uspeo za OrderID="
        ...
        @RequestMapping(value = { "/payment/success", "/payment/return" }, method = { RequestMethod.GET,
                        RequestMethod.POST })
        public RedirectView paymentSuccess(@RequestParam Map<String, String> params) {
                ...
                if (!signatureValid) {
                        System.out.println("[PaymentRoute] UPOZORENJE: nevažeći potpis na /payment/success za OrderID="
                                        + orderId);
                ...
                try {
                        ...
                        System.err.println(
                                        "[PaymentRoute] Upis u uplatnica/pohadja nije uspeo (preko /payment/success) za OrderID="
                                                        + orderId + ": " + e.getMessage());
                        e.printStackTrace();
                }
        ...
        public RedirectView paymentFailure(@RequestParam Map<String, String> params) {
                ...
                boolean signatureValid = paymentService.verifySignature(params);
                if (!signatureValid) {
                        System.out.println("[PaymentRoute] UPOZORENJE: nevažeći potpis na /payment/failure za OrderID="
                                        + orderId);
                }
        ...
        // Pomoćna metoda za sigurno dohvatanje ključeva nezavisno od malih/velikih
        // slova
